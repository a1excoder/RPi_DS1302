...
#/********************************************/
   def InitiateDS1302(self):
      RPi.GPIO.setup(self.sclk, RPi.GPIO.OUT, initial=0)
      RPi.GPIO.setup(self.rst, RPi.GPIO.OUT, initial=0)
      RPi.GPIO.setup(self.dat, RPi.GPIO.OUT, initial=0)
      RPi.GPIO.output(self.sclk, 0)
      RPi.GPIO.output(self.dat, 0)
...
#/*******************************************/
   def WriteByte(self, Byte):
      for Count in range(8):
         ...
         time.sleep(self.CLK_PERIOD)
         RPi.GPIO.output(self.dat, Bit)

         time.sleep(self.CLK_PERIOD)
         RPi.GPIO.output(self.sclk, 1)
...
#/******************************************/
   def ReadByte(self):
      RPi.GPIO.setup(self.dat, RPi.GPIO.IN, pull_up_down=RPi.GPIO.PUD_DOWN)
